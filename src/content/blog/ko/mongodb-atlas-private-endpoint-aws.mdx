...
```
com.amazonaws.vpce.ap-northeast-2.vpce-svc-01c8a34498a800fa3
```
...
aws ec2 create-vpc-endpoint \
  ...
  --service-name com.amazonaws.vpce.ap-northeast-2.vpce-svc-01c8a34498a800fa3 \
...
```bash
# 이렇게 하면 No answer
nslookup deteamcluster-pl-0.cqph4.mongodb.net
```
...
```bash
nslookup -type=SRV _mongodb._tcp.deteamcluster-pl-0.cqph4.mongodb.net
```

정상이면 아래처럼 포트 3개가 나온다.

```
_mongodb._tcp.deteamcluster-pl-0.cqph4.mongodb.net  service = 0 0 1024 pl-0-ap-northeast-2.cqph4.mongodb.net.
_mongodb._tcp.deteamcluster-pl-0.cqph4.mongodb.net  service = 0 0 1025 pl-0-ap-northeast-2.cqph4.mongodb.net.
_mongodb._tcp.deteamcluster-pl-0.cqph4.mongodb.net  service = 0 0 1026 pl-0-ap-northeast-2.cqph4.mongodb.net.
```
...
```bash
nslookup pl-0-ap-northeast-2.cqph4.mongodb.net
```

정상이면 `172.31.x.x` 같은 private IP가 나온다.

```
pl-0-ap-northeast-2.cqph4.mongodb.net
  canonical name = vpce-04284ffcac3cc4d56-pmuap28o.vpce-svc-01c8a34498a800fa3.ap-northeast-2.vpce.amazonaws.com.

Address: 172.31.101.192
Address: 172.31.127.196
```
...
```bash
telnet pl-0-ap-northeast-2.cqph4.mongodb.net 1024
telnet pl-0-ap-northeast-2.cqph4.mongodb.net 1025
telnet pl-0-ap-northeast-2.cqph4.mongodb.net 1026
```
...
```
# 일반 (쓰면 안 됨)
mongodb+srv://admin:***@deteamcluster.cqph4.mongodb.net/

# Private Endpoint용 (-pl-0 이 붙는다)
mongodb+srv://admin:***@deteamcluster-pl-0.cqph4.mongodb.net/
```
